...
/*
 * Author: Shahzada Gulfam, Gurbir Bains 
 * Date: January, 2016
...
public class SnakeGame extends JPanel implements KeyListener, ActionListener
{
	...
	//Gurbir - JButtons required for pause Menu
	...
	{ 
		...
		//Gurbir - Adding action listeners to the buttons and setting their focus to false
	...
	{ 
		//Gurbir - Check if the play again button has been pressed
	...
	protected void paintComponent(Graphics g)
	{
		...
		//Gurbir - Live score in corner
		g.setColor(Color.WHITE);
		g.setFont(new Font("TimesRoman", Font.PLAIN, 15)); 
		g.drawString("Tail Length: " + tailLength, 680, 50);
		g.drawString("Score: " + score, 680, 25);

		//Gurbir - If the dir is null, or the game has not been started yet
		if (dir == null)
		{
		...
		//Gurbir - If the player has crashed, show their score, and tell them game over
		if (crash)
		{
	...
	{ 
		...
		//Gurbir - If the user presses P to pause the game
	...
	//Gurbir - Method called to show or not show the menu
	...
	//Gurbir - Method to show, or not show the play again menu
