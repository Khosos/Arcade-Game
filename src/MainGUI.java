...
public class MainGUI implements ActionListener{
	...
	private JLabel settingsBG, lblSettingsTitle, hsBG, hsTitle, playSnake, lblNewLabel, background, dSnake, playFlappy, lblPlayer; 
	...
	public MainGUI(HighscoresList list, String player, String fileName) 
	{
		...
		settingsBG = new JLabel(new ImageIcon ("createAccountBG.jpg")); 
		...
		lblNewLabel = new JLabel(new ImageIcon("maintitle.png"));
		...
		dSnake = new JLabel(new ImageIcon("snakeDescription.png"));
		dSnake.setBounds(-100, 150, 504, 360);
		frmArcade.getContentPane().add(dSnake);
		
		// option to play snake game
		playSnake = new JLabel(new ImageIcon("playSnake.png"));
		playSnake.setBounds(50, 231, 280, 59);
		frmArcade.getContentPane().add(playSnake);
		
		//option to play bainsy bird
		playFlappy = new JLabel(new ImageIcon("playFlappy.png"));
		...
		//High scores picture 
		hsBG = new JLabel (new ImageIcon ("hsBG.png")); 
		...
		background = new JLabel(new ImageIcon("mainBG.png"));	
	...
	public void updateHighscores()
	{
		...
		list.writeToFile("Data.txt");  //writes to file data
	}
	...
	//action performed method
	{
		...
		{ 
			list.insertSort2(2); //Int 1 represents Snake Game
			updateList(listModelHS); 
		}

		else if (e.getSource() == btnSort2)
		{ 
			list.insertSort2(1); //Int 2 represents Flappy Game
			updateList(listModelHS); 
		}
	}
